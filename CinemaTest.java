...
public class CinemaTest {
	...
	public static void main(String[] args) throws FileNotFoundException {
			...
			**/
			...
			String thirdMovie = movieList.get(2);
			String fourthMovie = movieList.get(3);

			Scanner input = new Scanner(System.in); // 'in' variable can be used to take data from the user into the
			...
			if (enteredYN.equalsIgnoreCase(yes)) {
				...
				if (entered.equalsIgnoreCase(fourthMovie) && enteredYN.equalsIgnoreCase(yes))
				{
					...
					childA.bookMovie(movie4, employee3, false, childA);
				}
				...
				File availableFood = new File("availablefood.txt");
				Scanner food = new Scanner(availableFood);
